			...
			<div class="table-responsive">
			  <table class="table table-striped table-facturas datos">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<input type="hidden" value="<?php echo $descripcion;?>" id="descripcion<?php echo $id_gastos;?>">

					<input type="hidden" value="<?php echo $date_added;?>" id="date_added<?php echo $id_gastos;?>">


					<input type="hidden" value="<?php echo number_format($valor_gasto,0,'.','');?>" id="valor_gasto<?php echo $id_gastos;?>">
					...
					<a href="#" class='btn btn-default' title='Editar gasto' onclick="obtener_datos('<?php echo $id_gastos;?>');" data-toggle="modal" data-target="#myModal2"><span class="fa fa-pencil-square-o fa-1x icono-table"></span></a> 
